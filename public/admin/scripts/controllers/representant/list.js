angular.module('dmt-back').controller('representantListController',
	function ($scope, $mdDialog,
		...
		$scope.$watch('ctrl.user',(_new,_old,_scope)=>{
			if(_new){
				ctrl.entities[ctrl.entity].query.filters['email'] = [_new.email]
				ctrl.update()
			}else{
				delete ctrl.entities[ctrl.entity].query.filters['email']
				ctrl.update()
			}
		})
