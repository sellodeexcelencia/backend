angular.module('dmt-back').controller('detailItemRepresentantController', function ($mdDialog, $mdEditDialog, $routeParams, page, $location, $http, $filter) {
	var ctrl = this;
	ctrl.data = {};
	ctrl.language = 1;
	ctrl.entities = {};
	...
	ctrl.entities.institution.originalInstitution = -1
